...
class MeetingAgenda(Base):
    ...
    agenda_id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    ...
    def __repr__(self):
        return f"<MeetingAgenda(agenda_id={self.agenda_id}, meeting_id={self.meeting_id}, title='{self.title[:50]}...')>" 
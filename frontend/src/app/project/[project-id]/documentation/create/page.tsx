...
const CreateDocumentation: React.FC<CreateDocumentationProps> = ({ params }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      const documentData: DocumentationCreate = {
        title: title.trim(),
      ...
      const response = await documentationApi.create(documentData);
                ...
                {isPreviewMode ? (
                  <div 
                    ...
                    dangerouslySetInnerHTML={{ 
                      __html: content ? renderMarkdownPreview(content) : '<p class="text-gray-400 italic">Nothing to preview yet. Switch to write mode to start creating your document.</p>' 
                    }}
                  />
                ) : (
                  <textarea
